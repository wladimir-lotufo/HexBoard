# Script to update relative paths in all moved component files
# Changes ../../../../ to ../../../../../ (adds one more level)
...
Write-Host ""
Write-Host "All relative paths updated successfully!" -ForegroundColor Green
